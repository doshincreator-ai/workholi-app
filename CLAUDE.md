...
| versionCode | 日付 | 主な変更 |
|-------------|------|---------|
| 13（次回ビルド予定） | 2026/04/06 | バグ修正6件（payCalculator年収換算・Firestore同期エラーログ・シフトID検証・displayNameクラッシュ・曜日計算・通知エラーログ）|
| 12 | 2026/04/04 | Google Play クローズドテスト（Alpha）提出 |
| 11 | 2026/04/03 | Play Console 証明書リセット後の再ビルド |
| 10 | 2026/04/02 | Alpha 公開用ビルド |
| 8 | （それ以前） | NZ最低賃金 $23.95、AU最低賃金 $24.95、NZ ACC 1.67%、AU公休日×2.25に更新 |
